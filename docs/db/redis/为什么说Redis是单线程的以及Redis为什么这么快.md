...
3、采用单线程，避免了不必要的上下文切换和竞争条件，也不存在多进程或者多线程导致的切换而消耗 CPU，不用去考虑各种锁的问题，不存在加锁释放锁操作，没有因为可能出现死锁而导致的性能消耗；（在内存操作，没有必要用多线程的方式进行）
...
（1）硬盘数据库的工作模式：
![1](https://txxs.github.io/pic/tofuturedbredis/7-1.png)

（2）内存数据库的工作模式：
![1](https://txxs.github.io/pic/tofuturedbredis/7-2.png)
...
![1](https://txxs.github.io/pic/tofuturedbredis/7-3.png)
...
![1](https://txxs.github.io/pic/tofuturedbredis/7-4.png)
...
![1](https://txxs.github.io/pic/tofuturedbredis/7-5.png)
...
![1](https://txxs.github.io/pic/tofuturedbredis/pic/tofuturedbredis/7-6.png)
